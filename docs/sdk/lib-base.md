...
|  [LPStake](./lib-base.lpstake.md) | Represents a user's LP stake and accrued gains. |
...
|  [LPStakeChange](./lib-base.lpstakechange.md) | Represents the change between two states of an LP Stake. |
